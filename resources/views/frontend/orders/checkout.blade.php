...
@section('content')
<!-- header end -->
<div class="breadcrumb-area pt-205 breadcrumb-padding pb-80" style="background-image: url('https://i.pinimg.com/474x/b7/b8/1f/b7b81f60983570b78063c8d41148cd8d.jpg')">
	<div class="container">
		<div class="breadcrumb-content text-center">
			<h2>Checkout</h2>
			<ul>
				<li>
					Silahkan isi form dibawah ini untuk melanjutkan ke pembayaran
				</li>
			</ul>
		</div>
	</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="checkout-form-list">
									...
									<input type="text" name="username" value="{{ auth()->user()->username }}" placeholder="Username ..." hidden>
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Nama Depan <span class="required">*</span></label>
									<input type="text" name="first_name" value="{{ auth()->user()->first_name }}" placeholder="Lengkapi ...">
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Nama Belakang <span class="required">*</span></label>
									<input type="text" name="last_name" value="{{ auth()->user()->last_name }}" placeholder="Lengkapi ...">
								</div>
							</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
									<label>Alamat Lengkap<span class="required">*</span></label>
									<input type="text" name="address1" value="{{ auth()->user()->address1 }}" placeholder="Lengkapi dengan nama jalan...">
								</div>
							</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
									<label>Detail Alamat</label>
									<input type="text" name="address2" value="{{ auth()->user()->address2}}" placeholder="Rumah, kantor, kost dll. (optional)...">
								</div>
							</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
							...
							<div class="col-md-6">
								<div class="checkout-form-list">
									...
									<input type="number" name="postcode" placeholder="Masukan Data Kode POS Valid..." value="{{ auth()->user()->postcode }}">
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Nomor Telepon (Aktif) <span class="required">*</span></label>
									<input type="text" name="phone" placeholder="08xxx..." value="{{ auth()->user()->phone }}">
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
					...
					<div class="your-order rounded">
						...
						<div class="your-order-table table-responsive">
							<table>
								<thead>
									<tr>
										<th class="product-name"><strong>Produk</strong></th>
								...
								<tbody>
									...
									<tr>
										<td colspan="2">
											<h3 class="text-center">Tidak ada produk di keranjang</h3>
										</td>
									</tr>
									@endforelse
								</tbody>
								<tfoot>
									...
									<tr class="cart-subtotal">
										<th>Biaya Pengiriman <br> ({{ $totalWeight }} gram)</th>
									...
									<tr class="cart-subtotal">
										...
										<td><strong><span class="total-amount">
											Rp {{ number_format(\Cart::getTotal()) }}</span></strong>
										</td>
									</tr>
								</tfoot>
							</table>
						...
						<div class="payment-method">
							<div class="payment-accordion">
								<div class="panel-group" id="faq">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h5 class="panel-title"><a data-toggle="collapse" aria-expanded="true" data-parent="#faq" href="#payment-1">
												Metode Pembayaran
											</a></h5>
										</div>
										<div id="payment-1" class="panel-collapse collapse show">
											<div class="panel-body">
												<p>
													Setelah ini, Anda akan diarahkan ke halaman pembayaran untuk menyelesaikan pesanan Anda.
													Beberapa metode pembayaran yang tersedia adalah: Transfer Bank, Kartu Kredit, dan E-Wallet.
													<br>
												</p>
											</div>
										</div>
								...
								<div class="order-button-payment">
									<input type="submit" id="test" value="Lanjutkan Pembayaran" />
								</div>
							</div>
						</div>
					</div>
